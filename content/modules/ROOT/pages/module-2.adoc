...
Wait a few seconds until Kiali is ready. 
...
----
NAME                       READY   STATUS    RESTARTS   AGE
grafana-6b6dfdf46c-6lmks   1/1     Running   0          6m29s
istiod-685b946668-tnh46    1/1     Running   0          8m49s
kiali-6c6764bdf8-c9zf7     1/1     Running   0          2m33s
----

When the Kiali deployment is ready, get the Kiali URL from the Route by running the following command:
...
image:kiali-dashboard.png[kiali-dashboard.png]
...
NOTE: The **OpenShift Console pods will restart** after a few seconds and you might have to login to OpenShift again.
...
NOTE: Congratulations! You have successfully installed and configured observability for Red Hat OpenShift Service Mesh in Ambient Mode.