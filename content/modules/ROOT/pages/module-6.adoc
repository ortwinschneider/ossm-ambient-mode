...
The waypoint proxy is the place where Istio in ambient mode enforces Layer 7 policies.
...
image:traffic-splitting.png[Traffic Splitting in Kiali]
...
image:traffic-mirror.png[Traffic Mirroring in Kiali]
...
NOTE: Congratulations! You have completed Module 6: Traffic Management in Ambient Mode.